...
| 严格的**时序实验设计**                | 2016~2021 年训练，2022 年测试，包含 单年训练 / 累加训练 双模式       |
| **全面超越 Drebin-Fixed**             | 相同训练条件下，准确率提升 **11.5%+**，F1 提升显著                   |
| 集成学习增强                          | SVM + Random Forest 软投票集成，性能进一步起飞                       |
| 完整复现脚本 + 数据对齐逻辑          | 一键运行出 8 张顶会级高清对比图                                      |
